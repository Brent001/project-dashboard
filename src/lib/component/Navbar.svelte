    ...
    <div class="relative">
      ...
      {#if showProfile}
        <div class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded shadow border border-gray-200 dark:border-gray-700 z-50">
          <a href="/dashboard/profile" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Profile</a>
          <a href="/dashboard/settings" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Settings</a>
          <button
